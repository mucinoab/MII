from sympy import symbols, sympify, solve, plot_implicit
...
print(fx.subs({x: nx, y: ny}).n(8), fy.subs({x: nx, y: ny}).n(8),
      abs(fx.subs({x: nx, y: ny}).n(20) - fy.subs({x: nx, y: ny}).n(20)), '\n')
